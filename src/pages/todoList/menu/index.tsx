import { MenuItem, SButton } from '@/components/todoList';
...
import { DatePicker, Empty, Spin, message } from 'antd';
import { PlusOutlined, SlackOutlined } from '@ant-design/icons';
import Icon from '@ant-design/icons/lib/components/Icon';
import * as icons from '@ant-design/icons';
import { TaskTypeModal } from '@/components/todoList/Tasks/TaskTypeModal';
...
export function MenuContainer({ onSearchChange }: TProps) {
