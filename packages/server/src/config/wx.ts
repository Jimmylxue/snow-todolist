export const weChat = {
  ...
  birthday_templateId: 'UUFjZyxaR2bMCmdci1DgtbYXaa6YfW8WqcrFToAzZgY', // 生日模板id

  pay_templateId: 'VskKV07bPOiBNRvtZ4qhyacOIF4DEbLsLuBSnP9IjO8', // 发薪模板id

  love_templateId: 'ZKd5Y2MfBnIW1TRtsa0DdGl_U9foRJNbNKO-eAKE0Jg', // 相恋模板id
